...
/* РАЗДЕЛ ФОТО
 *
 * title - заголовок который отображается в галерее
 * img - ссылка на фото, фотографии размещайте в папке /img/photos/
 *       фотографии следует сжимать
 * img_sm - уменьшенная версия этой же фотографии, папка /img/photos/small/
 */
$photos = [
    [
    ...
    [
        "title" => "Автор: Вольга Парры (Lillaa studio)",
